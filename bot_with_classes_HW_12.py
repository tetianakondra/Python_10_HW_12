...
COMMAND_WORDS = ["add", "change", "phone", "show all", "help", "birthday", "days_to_birthday", "save", "get_book", "find"]
    ...
    def unpaking_address_book(self):
        ...
        with open("address_book.csv", "r", newline = "") as fh:
            ...
            for row in reader:
                ...
                self.unpacked_data[row["name"]] = {"name": row["name"], "phones": users_phones_list, "birthday": row["birthday"]}
